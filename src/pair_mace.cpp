...
//vama
    device = c10::Device(torch::kXPU, localrank);
//  }

    device = c10::Device(torch::kXPU);
  if(rank == 0)
...
//    // Define the desired new precision
  //torch::Dtype new_dtype = torch::kFloat32;
//
  // Iterate through parameters and buffers
//  for (auto p : model.named_parameters()) {
//    p.value.to(new_dtype);
//  }
//
//  for (auto buffer : model.named_buffers()) {
//    buffer.value.to(new_dtype);
//  }
